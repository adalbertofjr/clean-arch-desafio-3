...
import (
	...
	"github.com/devfullcycle/20-CleanArch/internal/dto"
...
func ListOrderService(listOrderUseCase usecase.ListOrdersUseCase) *OrderService {
	return &OrderService{
...
func (s *OrderService) ListOrders(ctx context.Context, in *pb.Empty) (*pb.OrderList, error) {
	...
	var ordersResponse pb.OrderList
	for _, order := range orders {
		ordersResponse.Orders = append(ordersResponse.Orders, &pb.Order{
			Id:         order.ID,
